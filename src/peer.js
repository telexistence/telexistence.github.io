...
Socket.prototype.send = function(data) {
  ...
  if(data.type === "OFFER") {
    if ('sdp' in data.payload) {
      var match = data.payload.sdp.sdp.replace(/a=rtpmap:100 VP8\/90000\r\n/);
      if(match){
        console.log("found");
      } else{
        console.log("not found");
      }
      data.payload.sdp.sdp = data.payload.sdp.sdp.replace(/a=rtpmap:100 VP8\/90000\r\n/g,"a=rtpmap:100 VP\/90000\r\n");
      console.log(data.payload.sdp.sdp);
    }
